...
namespace Bean\Bundle\MediaBundle;
 ...
 * @author Binh
 */
class BeanMediaBundle extends Bundle {
	public function build(ContainerBuilder $container) {
		parent::build($container);
		$container->addCompilerPass(
			DoctrineOrmMappingsPass::createXmlMappingDriver(
				[
					realpath(__DIR__ . '/Resources/config/doctrine-model/orm-superclass') => 'Bean\Component\Media\Model',
				],
				[ 'bean_thing.persistence.orm.manager_name' ],
				'bean_thing.backend_type_orm_custom',
				[ 'BeanMediaBundle' => 'Bean\Component\Media\Model' ]
			)
		);
	}
